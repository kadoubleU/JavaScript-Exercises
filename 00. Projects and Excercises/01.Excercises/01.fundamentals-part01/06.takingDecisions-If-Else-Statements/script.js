...
if(population > 33) {
    const info = `${country}'s population is above average.`
    console.log(info);
}else {
    const average = 33 - population;
    const resultForPopulation = `${country}'s population is ${average} below average.`
    console.log(resultForPopulation);
}